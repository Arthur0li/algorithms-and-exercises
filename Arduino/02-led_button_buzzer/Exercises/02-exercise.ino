...
void loop() {
  ...
  // if the yellow button is pressed, turn on the yellow LED and the buzzer, otherwise turn them off
  ...
  // if the blue button is pressed, turn on the blue LED, otherwise turn it off
