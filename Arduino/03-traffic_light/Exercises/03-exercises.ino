...
void loop() {
	...
	// turn on the yellow LEDs for 2 seconds, then turn on the red LEDs for 2 seconds, then turn off all the LEDs for 2 seconds and repeat this cycle indefinitely
	...
	// turn on the red LEDs for 2 seconds, then turn off all the LEDs for 2 seconds and repeat this cycle indefinitely
  	digitalWrite(green1, LOW);
  	digitalWrite(yellow1, LOW);
	...
	// turn off all the LEDs for 2 seconds and repeat this cycle indefinitely
  	digitalWrite(green1, LOW);
  	digitalWrite(yellow1, LOW);
  	digitalWrite(red1, HIGH);
