// set the pin numbers for the LEDs, buzzer and the button
int red1 = 1;
int yellow1 = 2;
int green1 = 3;
...
void checkButtonPress() {
  ...
  // sound the buzzer to indicate that the pedestrian request has been registered
...
void pedestrianCrossing() {
  ...
  // blink the pedestrian green light on and off at regular intervals until the total blink time has elapsed
